package tomson124.hazardousresearch.recipes;

import net.minecraft.item.ItemStack;
import net.minecraft.nbt.NBTTagCompound;
import tomson124.hazardousresearch.api.power.IEnergyInterfaceTile;
import tomson124.hazardousresearch.api.recipe.IBaseRecipeType;
import tomson124.hazardousresearch.api.recipe.IRecipeCrafterProvider;
import tomson124.hazardousresearch.api.recipe.RecipeHandler;
import tomson124.hazardousresearch.block.BlockMachineBase;
import tomson124.hazardousresearch.tile.base.TileEntityMachineBase;
import tomson124.hazardousresearch.util.Inventory;
import tomson124.hazardousresearch.util.ItemUtils;
import tomson124.hazardousresearch.util.LogHelper;
...
public class RecipeCrafter {
     ...
     */
    public TileEntityMachineBase parentTile;
     ...
     */
    public RecipeCrafter(String recipeName, TileEntityMachineBase parentTile, int inputs, int outputs, Inventory inventory,
        ...
        if(!(parentTile instanceof IRecipeCrafterProvider)){
            LogHelper.error(parentTile.getClass().getName() + " does not use IRecipeCrafterProvider report this to the issue tracker!");
        }
    }
